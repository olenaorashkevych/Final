    ...
    <section className="less-talk">
      <div className="container less-talk__container">
        ...
        <div className="less-talk__image">
          <img src="/images/Group2.png" alt="Dog walking" />
        </div>

        <div className="less-talk__content">
          <h2 className="less-talk__title">
          ...
          <button className="less-talk__button">
            Explore <span className="less-talk__button-lower">More</span>
          </button>
        </div>
